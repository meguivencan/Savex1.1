...
namespace Savex.Controllers.Expenses
{
    public class ExpenseTypesController : Controller
    {
        ...
        public ExpenseTypesController(SavexContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ExpenseTypeName,Comment")] ExpenseType expenseType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ExpenseTypeName,Comment")] ExpenseType expenseType)
        {
